...
public class FittingSwipeRecyclerViewAdapter extends RecyclerSwipeAdapter<FittingSwipeRecyclerViewAdapter.SimpleViewHolder> {
    ...
    public FittingSwipeRecyclerViewAdapter(Context context, ArrayList<Student> objects) {
...
//        });
        ...
        viewHolder.tvEmailId.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
